...
cd $B && HEADLESS=1 PX4_GZ_WORLD=sage_test PX4_SYS_AUTOSTART=4019 PX4_SIM_MODEL=gz_x500_mono_cam run px4 ../bin/px4 -d ../etc
...
echo "arming_state=$a"
sleep 10
P=/world/sage_test/model/x500_mono_cam_0/link/camera_link/sensor/imager
